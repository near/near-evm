...
pub fn create(_state: &mut dyn EvmState,
              _code: &Vec<u8>,
              _address: &Vec<u8>) {
   unimplemented!()
}
...
pub fn call(state: &mut dyn EvmState,
            call_stack_depth: usize,
            contract_address: &Vec<u8>,
            input: &Vec<u8>) -> Option<GasLeft> {
    run_and_commit_if_success(state,
                              call_stack_depth,
                              contract_address,
                              contract_address,
                              input,
...
pub fn delegate_call(state: &mut dyn EvmState,
                     call_stack_depth: usize,
                     context: &Vec<u8>,
                     delegee: &Vec<u8>,
                     input: &Vec<u8>) -> Option<GasLeft> {
 ...
 pub fn static_call(state: &mut dyn EvmState,
                    call_stack_depth: usize,
                    contract_address: &Vec<u8>,
                    input: &Vec<u8>) -> Option<GasLeft> {
     run_and_commit_if_success(state,
...
pub fn run_against_state(state: &dyn EvmState,
                         ...
                         code_address: &Vec<u8>,
                         input: &Vec<u8>,
                         is_static: bool) -> (Option<GasLeft>, Option<StateStore>) {
    ...
    let mut ext = NearExt::new(state_address.to_vec(), &mut sub_state, call_stack_depth, is_static);
